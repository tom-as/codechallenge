...
const Header = () => {
  ...
  */
  return (
    <div className='grid grid-cols-4 grid-rows-0 gap-0 pt-5 px-40'>
      ...
      <HeaderCard title="VIAJA SEGURO" img='src\assets\car.webp' desc="Cocoche cuenta con un seguro todo riesgo y retiene un deposito en la tarjeta como garantía."></HeaderCard>
